...
<div class="container">
    <div class="row mt-5">
        <div class="col">
            ...
            <form action="{{route('novo_funcionario_submit')}}" method="post">
                @csrf
                <div class="row">
                    {{-- funcionario --}}
                    <div class="col">
                        <div class="mb-3">
                            <label for="text_funcionario_name" class="form-label">Nome</label>
                                <input type="text" name="text_funcionario_name" id="text_funcionario_name" class="form-control" placeholder="Nome do funcionário" required value="{{old('text_funcionario_name')}}">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" name="text_funcionario_email" id="text_funcionario_email" class="form-control" placeholder="E-mail do funcionário" required value="{{old('text_funcionario_email')}}">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" name="text_funcionario_cpf" id="text_funcionario_cpf" class="form-control" maxlength="11" placeholder="CPF do funcionário" required value="{{old('text_funcionario_cpf')}}">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" name="text_funcionario_cargo" id="text_funcionario_cargo" class="form-control" placeholder="Cargo do funcionário" required value="{{old('text_funcionario_cargo')}}">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="date" name="date_funcionario_admissao" id="date_funcionario_admissao" class="form-control" required value="{{old('date_funcionario_admissao')}}">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="number" name="number_funcionario_salario" id="number_funcionario_salario" step="0.01" min="0" class="form-control" placeholder="Salário do funcionário" required value="{{old('number_funcionario_salario')}}">
